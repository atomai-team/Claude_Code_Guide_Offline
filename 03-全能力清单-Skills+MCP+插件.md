# Claude Code 全能力清单
> Skills × 151 · MCP × 12+ · 插件 × 多 · 外部 CLI × 4
> OMC V52.2 · 2026-06-12 完整版

---

## 第一部分：151 个 Skills 完整分类说明
...
- Skills: 100+ 原生 skill
- Hooks: 50+ 自动守护钩子
- Workflows: 10个 JS 流水线脚本
- MCP Tools: wiki/notepad/state/LSP/shared-memory 等
- Agents: 17 原子角色 + 13 战略角色 + 10 团队蓝图
...
*全能力清单更新：2026-06-12 | Skills: 151 · MCP: 12+插件MCP共20+ · Plugins: 10+ · Workflows: 10*
